const CountryCard = ({ data }) => {
	...
	return (
		<div id="" className="h-[350px] w-[250px] shadow shadow-slate-400 relative p-2 hover:scale-[1.03] ease-linear duration-[0.2s] rounded-md max-md:w-[190px] max-md:h-[250px] max-sm:h-[230px] max-sm:w-[160px] dark:bg-slate-800 dark:text-white"
		>
